...
# Start backend (using outer venv)
Write-Host "  [Backend] FastAPI on http://127.0.0.1:8000" -ForegroundColor Green
$backendCmd = "cd '$PSScriptRoot\..'; .\venv\Scripts\activate.ps1; cd glassdoor-dashboard\backend; uvicorn app.main:app --reload --host 0.0.0.0 --port 8000"
