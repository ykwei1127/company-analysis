...
export const runFinderMatch = (matchMode?: string, companies?: string[]) => api.post('/settings/finder/match', null, { params: { match_mode: matchMode, companies: companies?.join(',') } })
