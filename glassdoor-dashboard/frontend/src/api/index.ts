...
export const runFinderMatch = (matchMode?: string) => api.post('/settings/finder/match', null, { params: { match_mode: matchMode } })
export const runFinderScan = () => api.post('/settings/finder/scan')
